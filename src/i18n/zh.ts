...
export const zh: Messages = {
  ...
  lunarDateConverter: {
    ...
    sheetAriaLabel: "編輯要換算的日期",
    sheetTitle: "換算日期",
    ameGregorianLabel: "國曆日期",
    ameLunarLabel: "農曆日期",
    amePickerYear: "年",
    amePickerMonth: "月",
    amePickerDay: "日",
    ameSwitchToLunar: "切換為農曆輸入",
    ameSwitchToGregorian: "切換為國曆輸入",
    errorIncompleteDate: "請輸入完整日期",
    about: {
      heading: "什麼是國曆農曆轉換？",
  ...
  taiwanAnnualLeaveCalculator: {
    ...
    openCalendarAriaLabel: "開啟日曆",
    invalidHireDate: "到職日期無效",
    calendarLabel: "到職日期日曆",
    previousMonth: "上個月",
    nextMonth: "下個月",
    monthFieldLabel: "月",
    yearFieldLabel: "年",
    ...
    calendarYearLabel: "曆年制",
    resetLabel: "重設",
    infoAriaLabel: "試算方式說明",
    formulaHeading: "試算方式",
    calendarYearTip: "實際給假方式依勞僱約定為準。",
    definitionAnniversary: "特休天數",
    definitionCalendarYear: "特休天數",
    resultInitialSupport: "輸入到職日期，查看目前的特休天數。",
    supportHireTenure: "{date} 到職 · 年資 {tenure}",
    supportNextStage: "下一階段　{date} 起為 {days} 天",
    supportNextStageCalendarYear: "下一階段　{year} 年約 {days} 天",
    supportMaxReached: "已達法定特休最高 30 天",
    supportLeavePeriod: "給假期間　{start}–{end}",
    ameYearLabel: "年",
    ameMonthLabel: "月",
    ameDayLabel: "日",
    ...
    fixtureCalendarFormulaLines: ["7 天 × 6/12 = 3.5 天", "＋ 3 天 = 6.5 天"],
    fixtureMaxPrimary: "30",
    fixtureMaxSupport: "2000/09/15 到職 · 年資 26 年\n已達法定特休最高 30 天",
    fixtureMaxDateValue: "2000 / 09 / 15",
    about: {
      heading: "關於特休天數試算",
      body: "輸入到職日期，依週年制或曆年制試算目前的特休天數。結果以台灣現行特別休假規定為基礎，實際給假方式仍可能依公司制度與勞僱約定而不同。",
    },
    howTo: {
      heading: "如何使用特休天數試算",
      steps: [
      ...
      note: "Timiva 會記住你最後輸入的到職日期與給假方式，下次開啟時會依當天日期重新試算。",
    },
    commonUses: {
      heading: "常見用途",
      items: ["查特休天數", "到職年資", "週年制", "曆年制"],
    },
    faq: {
      heading: "特休天數試算 FAQ",
      items: [
    ...
    legal: {
      heading: "資料來源",
      body: "本工具依台灣現行勞動基準法特別休假規定進行試算，實際給假方式仍依個別勞動契約、公司制度與勞僱約定為準。",
      sources: [
        {
          label: "勞動部特別休假日數試算系統",
