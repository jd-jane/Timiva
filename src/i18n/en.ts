export const en = {
  ...
  taiwanAnnualLeaveCalculator: {
    ...
    openCalendarAriaLabel: "Open calendar (not enabled yet)",
    leaveSystemGroupAriaLabel: "Leave system",
    anniversaryLabel: "Anniversary",
    calendarYearLabel: "Calendar year",
    resetLabel: "Reset",
    infoAriaLabel: "How this estimate works (not enabled yet)",
    formulaHeading: "How it’s calculated",
    calendarYearTip:
      "Actual leave method and fractional-day handling follow your company and employment agreement.",
    definitionAnniversary: "Annual leave days",
    definitionCalendarYear: "Estimated calendar-year leave for this year",
    resultInitialSupport:
    ...
    /* B1B fixtures — static visual only */
