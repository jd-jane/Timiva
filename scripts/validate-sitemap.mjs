...
const EXPECTED_URLS = [
	...
	`${SITE}/en/business-days-calculator/`,
	`${SITE}/zh/business-days-calculator/`,
	`${SITE}/en/date-calculator/`,
	`${SITE}/zh/date-calculator/`,
	`${SITE}/en/hours-calculator/`,
	`${SITE}/zh/hours-calculator/`,
	`${SITE}/en/japanese-era-converter/`,
	`${SITE}/zh/japanese-era-converter/`,
	`${SITE}/en/lunar-date-converter/`,
	`${SITE}/zh/lunar-date-converter/`,
	`${SITE}/en/taiwan-annual-leave-calculator/`,
	`${SITE}/zh/taiwan-annual-leave-calculator/`,
	`${SITE}/en/privacy/`,
	`${SITE}/zh/privacy/`,
	`${SITE}/en/terms/`,
	`${SITE}/zh/terms/`,
...
const EXPECTED_HTML = [
	...
	"en/business-days-calculator/index.html",
	"zh/business-days-calculator/index.html",
	"en/date-calculator/index.html",
	"zh/date-calculator/index.html",
	"en/hours-calculator/index.html",
	"zh/hours-calculator/index.html",
	"en/japanese-era-converter/index.html",
	"zh/japanese-era-converter/index.html",
	"en/lunar-date-converter/index.html",
	"zh/lunar-date-converter/index.html",
	"en/taiwan-annual-leave-calculator/index.html",
	"zh/taiwan-annual-leave-calculator/index.html",
...
const PAIRS = [
	...
	["/en/taiwan-annual-leave-calculator/", "/zh/taiwan-annual-leave-calculator/"],
