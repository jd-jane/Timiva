...
const PAGES = [
	...
	{
		route: "/en/days-between-dates/",
		file: "en/days-between-dates/index.html",
		canonical: `${SITE}/en/days-between-dates/`,
	},
	{
		route: "/zh/days-between-dates/",
		file: "zh/days-between-dates/index.html",
		canonical: `${SITE}/zh/days-between-dates/`,
	},
	{
		route: "/en/business-days-calculator/",
		file: "en/business-days-calculator/index.html",
		canonical: `${SITE}/en/business-days-calculator/`,
	},
	{
		route: "/zh/business-days-calculator/",
		file: "zh/business-days-calculator/index.html",
		canonical: `${SITE}/zh/business-days-calculator/`,
	},
	{
		route: "/en/date-calculator/",
		file: "en/date-calculator/index.html",
		canonical: `${SITE}/en/date-calculator/`,
	},
	{
		route: "/zh/date-calculator/",
		file: "zh/date-calculator/index.html",
		canonical: `${SITE}/zh/date-calculator/`,
	},
	{
		route: "/en/hours-calculator/",
		file: "en/hours-calculator/index.html",
		canonical: `${SITE}/en/hours-calculator/`,
	},
	{
		route: "/zh/hours-calculator/",
		file: "zh/hours-calculator/index.html",
		canonical: `${SITE}/zh/hours-calculator/`,
	},
	{
		route: "/en/japanese-era-converter/",
		file: "en/japanese-era-converter/index.html",
		canonical: `${SITE}/en/japanese-era-converter/`,
	},
	{
		route: "/zh/japanese-era-converter/",
		file: "zh/japanese-era-converter/index.html",
		canonical: `${SITE}/zh/japanese-era-converter/`,
	},
	{
		route: "/en/lunar-date-converter/",
		file: "en/lunar-date-converter/index.html",
		canonical: `${SITE}/en/lunar-date-converter/`,
	},
	{
		route: "/zh/lunar-date-converter/",
		file: "zh/lunar-date-converter/index.html",
		canonical: `${SITE}/zh/lunar-date-converter/`,
	},
...
const PAIRS = [
	...
	["/en/business-days-calculator/", "/zh/business-days-calculator/"],
	["/en/date-calculator/", "/zh/date-calculator/"],
	["/en/hours-calculator/", "/zh/hours-calculator/"],
	["/en/japanese-era-converter/", "/zh/japanese-era-converter/"],
	["/en/lunar-date-converter/", "/zh/lunar-date-converter/"],
